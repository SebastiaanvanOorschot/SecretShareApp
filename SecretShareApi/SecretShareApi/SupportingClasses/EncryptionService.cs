...
namespace SecretShareApi.SupportingClasses
{
    public class EncryptionService
    {
        ...
        public virtual string Encrypt(string plainText, string passPhrase)
        {
            ...
            using (var password = new Rfc2898DeriveBytes(passPhrase, saltStringBytes, DerivationIterations))
            {
                ...
                using (var AesKey = Aes.Create())
                {
                    ...
                    using (var encryptor = AesKey.CreateEncryptor(keyBytes, ivStringBytes))
                    {
        ...
        public virtual string Decrypt(string cipherText, string passPhrase)
        {
